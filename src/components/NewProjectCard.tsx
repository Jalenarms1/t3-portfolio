...
export default function NewProjectCard({proj}: {proj: Project}) {
  return (
    <div className="flex max-sm:flex-col proj gap-5">
        ...
        <div className="w-3/4 max-sm:w-full px-4 py-2 flex justify-center items-center flex-col gap-2 max-sm:gap-4">
            ...
            <p className="text-zinc-100 text-md mb-4 w-3/4 max-sm:w-full text-center">{proj.description}</p>
