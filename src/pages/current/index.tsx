                    ...
                    <div key={i} className='flex flex-col items-center gap-8'>
                        ...
                        <div className='flex flex-col sm:[90%] md:w-[70%] lg:w-[60%] xl:w-[50%] 2xl:w-[45%]  m-auto p-4 rounded shadow-md shadow-cyan-600'>
                            ...
                            <p className='text-slate-50 leading-loose'> 
                                ...
                                <br />
                                <br />
                                I have also added a directory page. It required desiging a function in the server to communicate with the database to query for certain pieces of information based on the requested subject or filters, if any. A cool feature I added on was pagination, so the user can click a button to populate more information. This eliminates the need to query too much data at once, when the user can click to see more as much as they want.
